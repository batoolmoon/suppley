...
class ChangeStoreLanguage extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _ChangeStoreLanguageState();
  }

}

class _ChangeStoreLanguageState extends State<ChangeStoreLanguage>{
    ...
    if(isLogin == true){
      http.post(Uri.parse(funcs.mainLink+'api/changeLanguage'), body: {
        ...
        if(theResult['theResult'] == true){
          print("yess");
          Navigator.of(context).pushNamedAndRemoveUntil('/StoreDashboard',(Route<dynamic> route) => false);}
        else{
